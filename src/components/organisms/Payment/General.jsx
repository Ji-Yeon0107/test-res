...
import { cardArray, accountArray } from 'utility';
...
export default function General() {
        ...
        <GridWrap>
          {cardArray.map((array, idx) => (
            <GridList
              key={idx}
              onClick={() => {
                setActiveCard(array.key);
              }}
              active={activeCard === array.key}
            >
              <Img
          ...
          <Div as="ul">
            ...
            <Div as="li" dsp="flex" align="center" mgt="1rem">
              ...
              <Div style={{ position: 'relative' }}>
                ...
                <Div
                  mgt="1.1rem"
                  style={{ position: 'absolute', bottom: '-3rem', left: '0' }}
                >
                  <Form.CheckboxWrap>
                    <Form.Checkbox
                      type="checkbox"
                      ...
                      value="use1"
                    />
                    <Form.CheckboxLabel htmlFor="use1" />
            ...
            <Span as="li" color="#666" size="1.4rem" mgt="5rem">
              - M포인트 결제금액 최고 5%, 최대 5천포인트 (단, M포인트 적립 및
              사용이 가능한 카드에 한함)
            </Span>
          </Div>{' '}
          {/* ul */}
        ...
        <GridWrap>
          {accountArray.map((array, idx) => (
            <GridList
              key={idx}
              onClick={() => {
                setActiveAccount(array.key);
              }}
              active={activeAccount === array.key}
            >
              <Img
                pc={{ width: '7rem', height: '7rem' }}
                src={array.img}
  ...
  return (
    <>
      ...
      {paymentType === 'card' ? <CardBox /> : <AccountBox />}
      <GrayBox>
